...
def get_claude_prompt(text):
    ...
    The document has xml formatting and will be written in either English, Spanish or French.

    Your job is to correct any spelling or grammar mistake you see in the following text. You should also ensure that all sentences are written in a business-professional tone by updating sentences as needed. Do not change any of the xml formatting - all updates should be made in place within the .
